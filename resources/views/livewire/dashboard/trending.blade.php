<div class="py-9">
    ...
    <div class="max-w-[12rem] rounded overflow-hidden mt-9">
        <div class="shadow-lg mb-2">
            <img class="w-full" src="{{ asset('assets\images\no-way-home-card.jpg') }}" alt="Sunset in the mountains">
        </div>
        <div class="flex flex-row">
            ...
            <p class="text-gray-700 text-base ml-2">8.3/10</p>
        </div>
        <div class="font-bold text-base ">Spider-Man: No Way Home</div>
        <p class="text-gray-700 text-base">2021</p>
